...
io = require('./node_modules/socket.io-client/socket.io.js');

try {
  socket = io('http://localhost:3000');
  socket.on('connect', function() {
    return console.log('connected to refresh server');
  });
  socket.on('refresh', function() {
    return location.reload();
  });
} catch (_error) {
  console.log("refresh socket error");
}



},{"./node_modules/socket.io-client/socket.io.js":1}]},{},[2]);
